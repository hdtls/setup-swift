...
export function vsRequirement({ version }: any): VsRequirement {
...
async function setupSupportFiles({ version }: any, vsInstallPath: string) {
...
export async function setupVsTools(pkg: any) {
